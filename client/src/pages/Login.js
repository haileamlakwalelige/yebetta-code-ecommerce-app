...
const Login=()=>{
    ...
    return(
        <div className="bg-white flex justify-center items-center">
          <div className="flex flex-col pt-0 bg-white shadow-2xl mt-4 sm:mt-20 w-11/12 lg:w-5/12 h-5/6 lg:h-[550px] ">
            ...
            <div className="lg:pl-24 md:pl-5 sm:pl-2 justify-center sm:justify-start flex">
                <h1 className='font-semibold text-3xl pl-2 text-gray-700'>Welcome to Materialize! </h1>

                {/* <PiHandWavingBold /> */}
            </div>
            <p className="lg:pl-24 font-serif md:pl-12 pl-3 sm:pl-6 justify-center sm:justify-start text-gray-400">please sing-in to your account and start the adventure.</p>
            ...
            <div className='mt-[-10px] lg:pl-24 font-serif md:pl-12 md:mr-32 mr-10 sm:pl-6 pl-3 justify-center sm:justify-start text-gray-700'>
               ...
               <div className='flex pl-2'>
                ...
                <h1 className="text-purple-500">Forget Password ?</h1>
               </div>
            </div>
            <div className="md:mr-[220px] flex justify-center ml-20 mr-32 py-3">
            <button className='rounded text-center w-full p-1 lg:ml-24 font-serif md:ml-6 sm:ml-3 justify-center sm:justify-start text-white bg-purple-700'>LOGIN</button>
            </div>
            <div className='lg:pl-24 flex py-3  font-serif md:pl-6 sm:pl-3 md:justify-between lg:justify-start px-4 justify-center text-gray-400'>
                <h1 className="md:pr-3 pr-1 pl-1 md:pl-3">New to our platform ?</h1>
                <h1 className="text-purple-800">Create an account.</h1>
            </div>
